...
use cad_snap::{
    find_all_snaps, find_snap, Arc, Circle, DObject, Ellipse, Line, SnapHit, SnapKind, SnapSet,
    Vec2,
};
...
fn main() {
    ...
    println!(
        "Running osnaps: END={}  MID={}  CEN={}  QUA={}  INT={}  PER={}  TAN={}  NEA={}",
        osnaps.end,
        osnaps.mid,
        osnaps.cen,
        osnaps.qua,
    ...
    qua_only.qua = true;
    show(
        "right at the east quadrant (25, 0)",
        find_snap(
            Vec2::new(25.05, 0.05),
            1.0,
            qua_only,
    ...
    show(
        "on the rim but not at a quadrant",
        find_snap(
            Vec2::new(23.535, 3.535),
            1.0,
            qua_only,
    ...
    show(
        "hover circle's curve, forced CEN",
        find_snap(
            Vec2::new(25.0, 0.0),
            1.0,
            osnaps,
    ...
    show(
        "cursor at the extension foot (15, 0)",
        find_snap(
            Vec2::new(15.0, 0.05),
            1.0,
            osnaps,
