//! Thin binary entry point. All modules live in the `cad_app` library crate
//! (see `lib.rs`); this file owns only what a binary must: the panic hook, the
//! build stamp on stderr, and the `eframe` run loop.
...
fn main() -> Result<(), eframe::Error> {
    ...
    eprintln!("{}", cad_app::assets::report());
    ...
    let options = eframe::NativeOptions {
        viewport: eframe::egui::ViewportBuilder::default()
            ...
            .with_title(cad_app::window_title()),
        ..Default::default()
    };
    eframe::run_native(
        "simlux",
        ...
        Box::new(|cc| {
            ...
            cad_app::theme::install_fonts(&cc.egui_ctx);
            ...
            let mut a = cad_app::CadApp::default();
